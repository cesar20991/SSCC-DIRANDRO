...
<option>	CARLOS FERMIN FITZCARRALD	</option>
...
<option>	VICTOR FAJARDO	</option>
<option>	HUANCA SANCOS	</option>
<option>	VILCAS HUAMAN	</option>
<option>	PAUCAR DEL SARA SARA	</option>
<option>	SUCRE	</option>
...
<option>	HUAMALIES	</option>
<option>	MARAÑON	</option>
...
<option>	MARISCAL RAMON CASTILLA	</option>
<option>	DATEM DEL MARAÑON	</option>
<option>	TAMBOPATA	</option>
<option>	MANU	</option>
<option>	TAHUAMANU	</option>
<option>	MARISCAL NIETO	</option>
<option>	GENERAL SANCHEZ CERRO	</option>
<option>	ILO	</option>
<option>	PASCO	</option>
<option>	DANIEL ALCIDES CARRION	</option>
...
<option>	JORGE BASADRE	</option>
<option>	CANDARAVE	</option>
<option>	TUMBES	</option>
<option>	CONTRALMIRANTE VILLAR	</option>
