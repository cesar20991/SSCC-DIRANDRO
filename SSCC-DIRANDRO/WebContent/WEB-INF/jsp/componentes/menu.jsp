	...
	<div class="accordion" id="accordion2">
		<div class="accordion-group">
			...
			<div id="collapseOne" class="accordion-body collapse"
				style="height: 0px;">
				<div class="accordion-inner">Crear Caso Criminal</div>
		...
		<div class="accordion-group">
			...
			<div id="collapseThree" class="accordion-body collapse"
				style="height: 0px;">
				<div class="accordion-inner">Crear Punto de Acopio</div>
				<div class="accordion-inner">Buscar Punto de Acopio</div>
			</div>
		</div>
		<div class="accordion-group">
			<div class="accordion-heading">
			...
			<div id="collapseFour" class="accordion-body collapse"
				style="height: 0px;">
				<div class="accordion-inner">Buscar Rutas</div>
			</div>
		</div>
		<div class="accordion-group">
			<div class="accordion-heading">
			...
			<div id="collapseFive" class="accordion-body collapse"
				...
				<div class="accordion-inner">Buscar Sospechosos</div>
			</div>
		</div>
		<div class="accordion-group">
			<div class="accordion-heading">
