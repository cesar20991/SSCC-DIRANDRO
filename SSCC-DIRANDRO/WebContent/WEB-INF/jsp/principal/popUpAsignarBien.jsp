						...
						function(i, bien) {
							...
							$("#tblBody")
									.append(
											'<td>'
													+ bien.codigo
													+ '<input type="hidden" name="idBien" id="hdnBien_'+indiceBien+'" value="'+bien.idBien+'"></td>');
							$("#tblBody")
									.append(
											'<td><span id="spnPartidaRegistral_'+indiceBien+'">'
													+ bien.partidaRegistral
													+ '</span></td>'
													+ '<td><span id="spnValor_'+indiceBien+'">'
													+ bien.valor
													+ '</span></td>'
...
<body>
	...
	<div class="divMostrarBienAsignado">

				<legend>
					<span class="colored">///</span> Bienes:
				</legend>
				<div id="alertasAsignarCaso" style="display: none;"></div>
				<c:forEach items="${sospechosoList}" var="sospechoso">
					<span id="hdnIdSospechoso" style="display: none;"><c:out
							value="${sospechoso.idSospechoso}" /></span>
				</c:forEach>
